...
def expand_model_embeddings(ckpt_path, new_ckpt_path, num_new_tokens):
    ...
    if num_new_tokens <= 0:
        ...
        try:
            ...
            elif isinstance(temp_ckpt, dict) and ckpt_path.endswith(".safetensors"): 
    ...
    source_sd = None
    original_checkpoint_structure = {} 
    is_ema_prefix_present = False 
    ...
    bias_key = 'transformer.text_embed.text_embed.bias' 
    
    proj_key = 'transformer.proj_out.weight'
    proj_bias_key = 'transformer.proj_out.bias' 
    ...
    old_proj = cleaned_sd.get(proj_key) 
