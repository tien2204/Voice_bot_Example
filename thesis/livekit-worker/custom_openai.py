...
from livekit.plugins.openai.utils import (
...
class LLM(llm.LLM):
    def __init__(
        ...
        *,
        ...
        self.static_user_prompt = static_user_prompt
    ...
    def chat(
        ...
        *,
        ...
        return LLMStream(
            ...
            extra_kwargs=extra,
            static_user_prompt=self.static_user_prompt,
        )
...
class LLMStream(llm.LLMStream):
    ...
    async def _run(self) -> None:
        ...
        try:
            ...
            if self.static_user_prompt and chat_ctx and chat_ctx[-1]["role"] == "user":
                chat_ctx[-1]["content"] = "".join(
                    self.static_user_prompt,
                    "\n\n",
                    str(chat_ctx[-1]["content"]),
                )
