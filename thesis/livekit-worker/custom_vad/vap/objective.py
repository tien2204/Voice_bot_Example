...
class ProjectionWindow:
    def __init__(
        self,
        bin_times: List[int] = [0.2, 0.4, 0.6, 0.8],
        frame_hz: int = 50,
        ...
        self.bin_frames = (torch.tensor(bin_times) * frame_hz).long().tolist()
...
class ObjectiveVAP(nn.Module):
    def __init__(
        ...
        self.bin_frames: List[int] = self.projection_window_extractor.bin_frames
