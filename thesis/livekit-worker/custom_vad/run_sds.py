...
class AudioInputStereo:
    def __init__(
        self,
        filename=str(Path(__file__).parent/"data/sds_audio.wav"),
        frame_length=0.02,
        sample_width=2,
        sample_rate=16_000,
        channels=2,
...
class TurnTakingSDS:
    def __init__(
        self,
        conf:SDSConfig,
        audio_file: str = str(Path(__file__).parent/"data/audio.wav"),
...
if __name__ == "__main__":
    (Path(__file__).parent/"data").mkdir(exist_ok=True,parents=True)
