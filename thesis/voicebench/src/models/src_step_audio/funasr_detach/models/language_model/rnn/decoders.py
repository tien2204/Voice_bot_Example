...
class Decoder(torch.nn.Module, ScorerInterface):
    ...
    def recognize_beam(self, h, lpz, recog_args, char_list, rnnlm=None, strm_idx=0):
        ...
        ctc_weight = getattr(recog_args, "ctc_weight", False)  
...
def decoder_for(args, odim, sos, eos, att, labeldist):
    return Decoder(
        ...
        getattr(args, "context_residual", False),  
        getattr(args, "replace_sos", False),  
